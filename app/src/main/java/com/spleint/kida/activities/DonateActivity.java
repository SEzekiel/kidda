...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "spleint.kida.donate_1";
    private static final String DONATION_2 = "spleint.kida.donate_2";
    private static final String DONATION_3 = "spleint.kida.donate_3";
    private static final String DONATION_5 = "spleint.kida.donate_5";
    private static final String DONATION_10 = "spleint.kida.donate_10";
    private static final String DONATION_20 = "spleint.kida.donate_20";
