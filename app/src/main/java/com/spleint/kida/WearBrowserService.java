...
import com.spleint.kida.dataloaders.AlbumLoader;
import com.spleint.kida.dataloaders.AlbumSongLoader;
import com.spleint.kida.dataloaders.ArtistAlbumLoader;
import com.spleint.kida.dataloaders.ArtistLoader;
import com.spleint.kida.dataloaders.ArtistSongLoader;
import com.spleint.kida.dataloaders.PlaylistLoader;
import com.spleint.kida.dataloaders.PlaylistSongLoader;
import com.spleint.kida.dataloaders.SongLoader;
import com.spleint.kida.models.Album;
import com.spleint.kida.models.Artist;
import com.spleint.kida.models.Playlist;
import com.spleint.kida.models.Song;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "spleint.kida/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "spleint.kida/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "spleint.kida/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "spleint.kida/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
